...
export default {
  ...
  setup() {
    ...
    const tmp = {
      ...
      풀업: "https://images.unsplash.com/photo-1616803689943-5601631c7fec?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80",
      바벨로우:
        "https://images.unsplash.com/photo-1616803689943-5601631c7fec?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80",
      인버티드로우:
    ...
    const changeValue = (res,idx,k) => {
      ...
      arr[idx][k] = v>0 ? v : 0;
      arr[idx]['total'] = arr[idx]['set'] * arr[idx]['rep'] * arr[idx]['weight'];
    }
    ...
    return { selected, tmp, arr, onchange, addWorkout, minusWorkout, changeValue };
  },
};
</script>
